...
## -- Dublin Core Terms (DCTERMS) {.smaller}
...
## -- Openthéso (Huma-Num instance) {.smaller}
...
## -- EXIF: Metadata Already in the File {.smaller}
...
**Experimental:** [tropy-plugin-nakala](https://gitlab.huma-num.fr/bmorandiere/tropy-plugin-nakala) by Bruno Morandière
...
📚 [docs.tropy.org](https://docs.tropy.org)  
▶️ [vimeo.com/user104478141](https://vimeo.com/user73164761)  
▶️ [youtube.com/@tropy](https://www.youtube.com/@tropyorg)  
💬 [forums.tropy.org](https://forums.tropy.org)
...
## Beyond Description — Visualizing Your Corpus {.smaller}
...
🔗 [vikusviewer.fh-potsdam.de](https://vikusviewer.fh-potsdam.de)
...
**Pactols / Openthéso:** [pactols.frantiq.fr](https://pactols.frantiq.fr) · [opentheso.huma-num.fr](https://opentheso.huma-num.fr)

**IIIF:** [iiif.io](https://iiif.io) · [iiif.io/api/cookbook](https://iiif.io/api/cookbook/)

**Tropy:** [docs.tropy.org](https://docs.tropy.org) · [forums.tropy.org](https://forums.tropy.org)

**Nakala:** [nakala.fr](https://nakala.fr)

**Arvest:** [arvest.app](https://arvest.app) 

**VIKUS Viewer:** [vikusviewer.fh-potsdam.de](https://vikusviewer.fh-potsdam.de)