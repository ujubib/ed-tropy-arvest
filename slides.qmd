...
## Agenda {background-color="#003865" .center}
...
# Part 1 {background-gradient="linear-gradient(135deg, #003865 0%, #2297D4 100%)" .center}
...
🔗 [opentheso.frantiq.fr](https://opentheso.frantiq.fr)
...
# Part 2 {background-gradient="linear-gradient(135deg, #003865 0%, #2297D4 100%)" .center}
...
Omeka S **auto-generates** IIIF Manifests for every item with an image.

```
https://omeka.univ-pau.fr/iiif/3/{itemId}/manifest
```

Any collection built in the UPPA Omeka S instance is **immediately available as a IIIF source** — importable in Arvest with a single URL.
...
# Part 3 {background-gradient="linear-gradient(135deg, #003865 0%, #2297D4 100%)" .center}
...
## Q & A {background-gradient="linear-gradient(135deg, #003865 0%, #2297D4 100%)" .center}

::: {style="text-align:center; font-size:1.8em; color:white; margin-top:1.5rem;"}
Questions?
:::

::: {style="text-align:center; margin-top:2rem; color:rgba(255,255,255,0.9); line-height:2;"}
**Julien Rabaud** · UPPA · Pôle Numérique
...
[ujubib.github.io/ed-tropy-arvest/slides.html](https://ujubib.github.io/ed-tropy-arvest/slides.html) · [![CC BY 4.0](https://licensebuttons.net/l/by/4.0/80x15.png)](https://creativecommons.org/licenses/by/4.0/)
:::
